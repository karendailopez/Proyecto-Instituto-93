                                ...
                                <div className="report-box zoom-in">
                                    <div className="box p-5">
                                        <div className="flex">
                                            ...
                                            <div className="ml-auto">
                                                <div className="report-box__indicator bg-theme-6 tooltip cursor-pointer"
                        ...
                        <div className="mt-5">
                                ...
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                             src="dist/images/profile-6.jpg"></img>
                                    </div>
                            ...
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                             src="dist/images/profile-13.jpg"></img>
                                    </div>
                                    <div className="ml-4 mr-auto">
                            ...
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                             src="dist/images/profile-3.jpg"></img>
                                    </div>
                                    <div className="ml-4 mr-auto">
                        ...
                        <div className="intro-y block sm:flex items-center h-10">
                            ...
                            <div className="flex items-center sm:ml-auto mt-3 sm:mt-0">
                                ...
                                <button className="ml-3 btn box flex items-center text-gray-700 dark:text-gray-300"><i
                                    data-feather="file-text" className="hidden sm:block w-4 h-4 mr-2"></i> Export to PDF
                                </button>
                            </div>
                        </div>
                                    ...
                                    <td className="w-40">
                                        <div className="flex">
                                            <div className="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-12.jpg"
                                                     title="Uploaded at 16 November 2021"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-6.jpg"
                                                     title="Uploaded at 12 April 2021"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-8.jpg"
                                ...
                                <tr className="intro-x">
                                    <td className="w-40">
                                        <div className="flex">
                                            <div className="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-13.jpg"
                                                     title="Uploaded at 22 July 2022"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-10.jpg"
                                                     title="Uploaded at 3 July 2022"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-14.jpg"
                                ...
                                <tr className="intro-x">
                                    <td className="w-40">
                                        <div className="flex">
                                            <div className="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-3.jpg"
                                                     title="Uploaded at 11 October 2021"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-2.jpg"
                                ...
                                <tr className="intro-x">
                                    <td className="w-40">
                                        <div className="flex">
                                            <div className="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-7.jpg"
                                                     title="Uploaded at 29 April 2022"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-1.jpg"
                                                     title="Uploaded at 5 February 2021"></img>
                                            </div>
                                            <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     className="tooltip rounded-full" src="dist/images/preview-15.jpg"
                                    ...
                                    <td>
                                        ...
                                        <div className="text-gray-600 text-xs whitespace-nowrap mt-0.5">Electronic</div>
                                    </td>
                                    <td className="text-center">50</td>
                                    <td className="w-40">
                                        <div className="flex items-center justify-center text-theme-6"><i
                    ...
                    <div className="2xl:pl-6 grid grid-cols-12 gap-6">
                            ...
                            <div className="report-timeline mt-5 relative">
                                <div className="intro-x relative flex items-center mb-3">
                                    <div className="report-timeline__image">
                                        <div className="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Rubick Tailwind HTML Admin Template"
                                                 src="dist/images/profile-12.jpg"></img>
                                        </div>
                                    </div>
                                        ...
                                        <div className="text-gray-600">
                                            ...
                                            <div className="flex mt-2">
                                                ...
                                                <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in"
                                                    ...
                                                    <img alt="Rubick Tailwind HTML Admin Template"
                                                         className="rounded-md border border-white"
                                                         src="dist/images/preview-13.jpg"></img>
                                                </div>
                                                <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in"
                                                     title="Nikon Z6">
                                                    <img alt="Rubick Tailwind HTML Admin Template"
                                                         className="rounded-md border border-white"
                                                         src="dist/images/preview-12.jpg"></img>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="intro-x relative flex items-center mb-3">
                                    <div className="report-timeline__image">
                                        <div className="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Rubick Tailwind HTML Admin Template"
                                                 src="dist/images/profile-10.jpg"></img>
                                        </div>
                                    </div>
                                    <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div className="flex items-center">
                            ...
                            <div className="mt-5 intro-x">
                                <div className="box zoom-in">
                                    <div className="tiny-slider" id="important-notes">
                                        <div className="p-5">
                                            <div className="text-base font-medium truncate">Lorem Ipsum is simply dummy
                                                text
                                            </div>
                                            <div className="text-gray-500 mt-1">20 Hours ago</div>
                                            <div className="text-gray-600 text-justify mt-1">Lorem Ipsum is simply dummy
                        ...
                        <div
                            ...
                            <div className="intro-x flex items-center h-10">
                                ...
                                <a href=""
                                   className="ml-auto text-theme-1 dark:text-theme-10 truncate flex items-center"> <i
