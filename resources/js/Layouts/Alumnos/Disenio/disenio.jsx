                        ...
                        <div className="intro-y box">
                            <div className="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                                <h2 className="font-medium text-base mr-auto">
                                    ...
                                    {mesa.materia && mesa.materia.descripcion ? mesa.materia.descripcion : 'Materia no disponible'}
                                </h2>
                            ...
                            <div className="p-5">
                                <div className="preview">
                                    ...
                                    <p>Presidente: {mesa.personal_presidente}</p>
                                    <p>Auxiliar: {mesa.personalAuxiliar}</p>
                                </div>
                            </div>
                        </div>
                    </div>
